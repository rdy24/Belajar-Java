...
public class GUI_Mahasiswa extends javax.swing.JFrame {
    ...
    String nim1,nama1,prodi1,ang1, Kodelama;
    ...
    public void update(){
        ...
        try {
            ...
            statement.executeUpdate("UPDATE tb_mahasiswa SET nim='"+Nim+"'," + "nama='"+Nama+"'"
                    + ",prodi='"+Prodi+"',angkatan='"+Ang+"'WHERE nim = '"+Kodelama+"'");
            statement.close();
            conn.close();
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(txtProdi, javax.swing.GroupLayout.DEFAULT_SIZE, 154, Short.MAX_VALUE)
